...
conn = mysql.connector.connect(
    host="localhost",
    user="root",
    password="",  # Nếu bạn có password MySQL thì điền vào đây
    database="tmdt",
)
cursor = conn.cursor()
...
# ==============================
# 8️⃣ Đồng bộ Products (thêm & cập nhật)
# ==============================
changes_added = []
changes_updated = []
...
# ==============================
# 9️⃣ Xóa sản phẩm không còn trong XML
# ==============================
...
if deleted_products:
    print("\n🗑️  Sản phẩm bị xóa do không còn trong XML:")
